...
class _CovidScreenState extends State<CovidScreen> {
  ...
  var vaccinationTypes = ["Covaxin", "Covishield", "Sputnik"];
  ...
  void initState() {
    ...
    provider.getUuidFromApi(context, widget.uuid);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: FAppBar.getCommonAppBar(title: "Covid Data"),
      body: Consumer<CovidProvider>(builder: (context, snapshot, child) {
        return Theme(
