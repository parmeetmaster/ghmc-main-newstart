...
class ResidentScanScreen extends StatefulWidget {
  final qrdata;
  final OperationModel operationData;

  const ResidentScanScreen({Key? key, this.qrdata, required this.operationData})
      : super(key: key);

  @override
  _ResidentScanScreenState createState() => _ResidentScanScreenState();
}

class _ResidentScanScreenState extends State<ResidentScanScreen> {
  bool? choice = null;
        ...
        return provider.dropDowns != null &&
            ...
            ? ListView(
                ...
                children: [
                  CardSeperateRow(
                    "Owner Name",
                    provider.commonResidentModel!.data!.ownerName,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Resident Type",
                    provider.commonResidentModel!.data!.houseType!,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Land",
                    provider.commonResidentModel!.data!.landmark,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Area",
                    provider.commonResidentModel!.data!.area,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Ward",
                    provider.commonResidentModel!.data!.wardName,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Circle",
                    provider.commonResidentModel!.data!.circle,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Zone",
                    provider.commonResidentModel!.data!.zone,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 10,
                    ...
                    child: GradientButton(
                      onclick: () async {
                        FormData formdata = FormData.fromMap({
                          'db_type': provider.commonResidentModel?.data?.dbType,

                          'user_id': Globals.userData?.data?.userId ?? "",
                          'collection_id':
                              provider.commonResidentModel?.data?.colId ?? "",
                          'wt_type': _weight,
                          'picked_denied':
