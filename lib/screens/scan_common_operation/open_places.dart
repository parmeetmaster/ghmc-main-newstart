...
class OpenPlacesScanScreen extends StatefulWidget {
  final qrdata;
  final OperationModel operationData;

  const OpenPlacesScanScreen({Key? key, this.qrdata, required this.operationData})
      : super(key: key);

  @override
  _OpenPlacesScanScreenState createState() => _OpenPlacesScanScreenState();
}

class _OpenPlacesScanScreenState extends State<OpenPlacesScanScreen> {
  bool? choice = null;
                    ...
                    child: GradientButton(
                      onclick: () async {
                        FormData formdata = FormData.fromMap({
                          'db_type': provider.commonOperationOpenPlaces?.data?.dbType,

                          'user_id': Globals.userData?.data?.userId ?? "",
                          'collection_id':
                              provider.commonOperationOpenPlaces?.data?.colId ?? "",
                          'wt_type': _weight,
                          'picked_denied':
