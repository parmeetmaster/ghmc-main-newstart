...
class CommercialScanBuilding extends StatefulWidget {
  final qrdata;
  final OperationModel operationData;

  const CommercialScanBuilding({Key? key, this.qrdata, required this.operationData})
      : super(key: key);

  @override
  _CommercialScanBuildingState createState() => _CommercialScanBuildingState();
}

class _CommercialScanBuildingState extends State<CommercialScanBuilding> {
  bool? choice = null;
  ...
  void initState() {
    ...
    provider.loadCommericalBuilding(widget.qrdata);
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: FAppBar.getCommonAppBar(title: "Commercial Building Scan"),
      body: Consumer<CommonScanProvider>(builder: (context, value, child) {
        return provider.dropDowns != null &&
                provider.commonOperationCommercialBuilding != null
            ? ListView(
                padding: EdgeInsets.all(10),
                children: [
                  CardSeperateRow(
                    "Complex Name",
                    provider.commonOperationCommercialBuilding!.data!.name,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Address",
                    provider.commonOperationCommercialBuilding!.data!.address,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Floors",
                    provider.commonOperationCommercialBuilding!.data!.floors!,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Landmark",
                    provider.commonOperationCommercialBuilding!.data!.landmark,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Area",
                    provider.commonOperationCommercialBuilding!.data!.area,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Ward",
                    provider.commonOperationCommercialBuilding!.data!.wardName,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Circle",
                    provider.commonOperationCommercialBuilding!.data!.circle,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Zone",
                    provider.commonOperationCommercialBuilding!.data!.zone,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 10,
                    ...
                    child: GradientButton(
                      onclick: () async {
                        FormData formdata = FormData.fromMap({
                          'db_type': provider.commonOperationCommercialBuilding?.data?.dbType,
                          'user_id': Globals.userData?.data?.userId ?? "",
                          'collection_id':
                              provider.commonOperationCommercialBuilding?.data?.colId ?? "",
                          'wt_type': _weight,
                          'picked_denied':
