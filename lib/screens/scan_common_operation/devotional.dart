...
class Divotional extends StatefulWidget {
  final qrdata;
  final OperationModel operationData;

  const Divotional({Key? key, this.qrdata, required this.operationData})
      : super(key: key);

  @override
  _DivotionalState createState() => _DivotionalState();
}

class _DivotionalState extends State<Divotional> {
  bool? choice = null;
