...
class CommunityScanScreen extends StatefulWidget {
  final qrdata;
  final OperationModel operationData;

  const CommunityScanScreen({Key? key, this.qrdata, required this.operationData})
      : super(key: key);

  @override
  _CommunityScanScreenState createState() => _CommunityScanScreenState();
}

class _CommunityScanScreenState extends State<CommunityScanScreen> {
  bool? choice = null;
  ...
  void initState() {
    ...
    provider.loadCommunity(widget.qrdata);
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: FAppBar.getCommonAppBar(title: "Community Hall Screen"),
      body: Consumer<CommonScanProvider>(builder: (context, value, child) {
        return provider.dropDowns != null &&
                provider.commonOperationCommunityHall != null
            ? ListView(
                padding: EdgeInsets.all(10),
                children: [
                  CardSeperateRow(
                    "Buisness Name",
                    provider.commonOperationCommunityHall!.data!.businessName,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Buisness Type",
                    provider.commonOperationCommunityHall!.data!.businessType,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Address",
                    provider.commonOperationCommunityHall!.data!.shopAddress,
                    fontsize: 16,
                  ),
                  ...
                  CardSeperateRow(
                    "Landmark",
                    provider.commonOperationCommunityHall!.data!.landmark,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Area",
                    provider.commonOperationCommunityHall!.data!.area,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Ward",
                    provider.commonOperationCommunityHall!.data!.wardName,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Circle",
                    provider.commonOperationCommunityHall!.data!.circle,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Zone",
                    provider.commonOperationCommunityHall!.data!.zone,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 10,
                    ...
                    child: GradientButton(
                      onclick: () async {
                        FormData formdata = FormData.fromMap({
                          'db_type': provider.commonOperationCommunityHall?.data?.dbType,

                          'user_id': Globals.userData?.data?.userId ?? "",
                          'collection_id':
                              provider.commonOperationCommunityHall?.data?.colId ?? "",
                          'wt_type': _weight,
                          'picked_denied':
