...
class TempleScanScreen extends StatefulWidget {
  final qrdata;
  final OperationModel operationData;

  const TempleScanScreen({Key? key, this.qrdata, required this.operationData})
      : super(key: key);

  @override
  _TempleScanScreenState createState() => _TempleScanScreenState();
}

class _TempleScanScreenState extends State<TempleScanScreen> {
  bool? choice = null;
  ...
  void initState() {
    ...
    provider.loadTempleDisplayData(widget.qrdata);
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: FAppBar.getCommonAppBar(title: "Temple Scan"),
      body: Consumer<CommonScanProvider>(builder: (context, value, child) {
        return provider.dropDowns != null &&
                provider.templeCommonOperation != null
            ? ListView(
                padding: EdgeInsets.all(10),
                children: [
                  CardSeperateRow(
                    "Temple Name",
                    provider.templeCommonOperation!.data!.templeName,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Incharge Name",
                    provider.templeCommonOperation!.data!.inchargeName,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Address",
                    provider.templeCommonOperation!.data!.address,
                    fontsize: 16,
                  ),
                  ...
                  CardSeperateRow(
                    "Landmark",
                    provider.templeCommonOperation!.data!.landmark,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Area",
                    provider.templeCommonOperation!.data!.area,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Ward",
                    provider.templeCommonOperation!.data!.wardName,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Circle",
                    provider.templeCommonOperation!.data!.circle,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 5,
                  ...
                  CardSeperateRow(
                    "Zone",
                    provider.templeCommonOperation!.data!.zone,
                    fontsize: 16,
                  ),
                  SizedBox(
                    height: 10,
                    ...
                    child: GradientButton(
                      onclick: () async {
                        FormData formdata = FormData.fromMap({
                          'db_type': provider.templeCommonOperation?.data?.dbType,

                          'user_id': Globals.userData?.data?.userId ?? "",
                          'collection_id':
                              provider.templeCommonOperation?.data?.colId ?? "",
                          'wt_type': _weight,
                          'picked_denied':
