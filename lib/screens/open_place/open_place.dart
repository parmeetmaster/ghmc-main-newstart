...
class _OpenPlaceScreenState extends State<OpenPlaceScreen> {
  ...
  void initState() {
    ...
    provider = Provider.of<OpenPlaceProvider>(context, listen: false);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Consumer<OpenPlaceProvider>(builder: (context, snapshot, child) {
...
//incharge mobile no
                    ...
                    GradientButton(
                      ...
                      onclick: () async {
                        ...
                        MProgressIndicator.show(context);
                        ApiResponse res =
                            await provider.createOpenPlace(formData, context);
                        print(res.status);
                        MProgressIndicator.hide();
                        if (res.status == 200) {
