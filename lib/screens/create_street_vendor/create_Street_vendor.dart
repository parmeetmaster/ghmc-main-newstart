...
@immutable
class CreateStreetVendor extends StatefulWidget {
  CreateStreetVendor({Key? key}) : super(key: key);

  @override
  _CreateStreetVendorState createState() => _CreateStreetVendorState();
}

class _CreateStreetVendorState extends State<CreateStreetVendor> {
